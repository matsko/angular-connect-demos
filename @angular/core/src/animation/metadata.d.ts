...
export declare class AnimationQueryMetadata extends AnimationMetadata {
    selector: string;
    steps: AnimationMetadata[];
    constructor(selector: string, steps: AnimationMetadata[]);
}
/**
 ...
 */
export declare function query(selector: any, animation: AnimationMetadata | AnimationMetadata[]): AnimationQueryMetadata;
